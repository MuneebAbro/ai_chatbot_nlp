...
Contact Information:
- Phone: ${config.contact?.phone || 'N/A'}
- Email: ${config.contact?.email || 'N/A'}
- Address: ${config.contact?.address || 'N/A'}
- Hours: ${config.contact?.hours || 'N/A'}
- Website: ${config.contact?.website || 'N/A'}

📞 **Important**: Always use the exact contact information provided above. Never make up or generate fake phone numbers, emails, or addresses. If contact information is not available, say so clearly.`;
    }
...
📞 **Important**: Always use the exact contact information provided in the business context. Never make up or generate fake phone numbers, emails, or addresses. If contact information is not available, say so clearly.`;
}
